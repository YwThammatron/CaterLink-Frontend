...
function WriteBlog() {
  ...
  const handleUpload = (e) => {
    ...
    if(currentfile){setBlogimg(currentfile)}
  }
  ...
  const handlePostImg = async () => {
    ...
    if(Blogimg != null){
      try{
            const response = await axios.post(baseUrl + "/api/blog_images",formdata,{
                headers:{
                    Authorization: `Bearer ${accessToken}`,
          ...
          <div className="w-[84%] h-auto bg-[#F9FAFB]">
            ...
            <div className="flex flex-col gap-[24px] w-auto h-[897px] items-center mb-[32px]">
                ...
                <div className="grid justify-center items-center border-[1px] border-[#F2F4F7] rounded-[24px] w-[1104px] h-[752px] bg-white">
                    ...
                    <div className="flex w-[1056px] h-[222px]">
                        ...
                        <form className="grid w-[512px] gap-[16px]">
                            <div className="grid h-fit gap-[6px]">
                                <label className="flex"><p className="flex h-[21px] font-[500] text-[#6D6E71] text-[14px]">หัวข้อบทความ</p><p className="text-[#D50A0A] pl-[3px]">*</p></label>
                                <input 
                                type="text"
                                id="title"
                                value={Payload.title}
                            ...
                            <div className="grid h-fit gap-[6px]">
                                <label className="flex"><p className="flex h-[21px] font-[500] text-[#6D6E71] text-[14px]">รูปปกบทความ</p> <p className="text-[#D50A0A] pl-[3px]">*</p></label>
                                <div className="relative">
                                    ...
                                    <div className="flex w-[40px] h-[40px] justify-center items-center shadow-sm border-[1px] border-[#EAECF0] rounded-[8px]">
                                        {Blogimg != null ? <Image className="h-fit w-[20px] h-[20px]"/> : <CloudUpload className="h-fit w-[20px] h-[20px]"/>}
                                    </div>

                                    {Blogimg != null ? 
                                        <div className="flex gap-[10px] text-[14px]">
                                            <p className="cursor-pointer text-[#F78E1E] font-[600]">{Blogimg.name}</p>
                    ...
                    <div className="flex w-[1056px] h-[166px]">
                        ...
                        <form className="grid w-[512px] gap-[6px]">
                            <label className="flex"><p className="flex h-[21px] font-[500] text-[#6D6E71] text-[14px]">ประเภทการจัดเลี้ยง</p><p className="text-[#D50A0A] pl-[4px]">*</p></label>
                            <div className="relative">
                                <select id="restaurant_main_category" value={Payload.restaurant_main_category} onChange={handleChange} className="appearance-none w-[512px] h-[48px] pl-[14px] pr-[42px] pt-[12px] pb-[12px] border-[1px] border-[#D0D5DD] rounded-md">
                            ...
                            <label className="flex"><p className="flex h-[21px] font-[500] text-[#6D6E71] text-[14px]">ประเภทงานอีเวนต์</p><p className="text-[#D50A0A] pl-[4px]">*</p></label>
                            <div className="relative">
                                <select id="restaurant_event_categories" value={Payload.restaurant_event_categories} onChange={handleChange} className="appearance-none w-[512px] h-[48px] pl-[14px] pr-[42px] pt-[12px] pb-[12px] border-[1px] border-[#D0D5DD] rounded-md">
                                    <option value="default" selected hidden>เลือกข้อมูล</option>
                    ...
                    <div className="flex w-[1056px] h-[153px]">
                        ...
                        <form className="grid w-[512px]">
                            <div className="grid h-fit gap-[6px]">
                                <label className="flex"><p className="flex h-[21px] font-[500] text-[#6D6E71] text-[14px]">เนื้อหา</p> <p className="text-[#D50A0A] pl-[4px]">*</p></label>
                                <textarea
                                id="detail"
                ...
                <div className="flex items-center gap-[100px] w-[1104px] h-[48px]">
                    ...
                    {/* Right */}
                    <div className="flex gap-[12px] ml-[887px]">
                        <Button
