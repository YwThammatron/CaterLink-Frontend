  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (response.data.userData.role == "customer") {
        ...
        window.alert(
          "System : Wrong login portal for restaurant. System will redirect you to restaurant portal."
        );
      ...
      <div className="flex justify-center">
        ...
        <div className="flex justify-center items-center w-[50%] h-[100vh]">
          ...
          <div className="w-[360px] h-[430px]">
            ...
            <Button
              onClick={handleLogin}
              className="w-[100%] h-[44px] bg-linear-to-r from-[#FF8A00] to-[#E9580A] rounded-[8px] hover:cursor-pointer"
            >
              เข้าสู่ระบบ
            </Button>
            ...
            <div className="flex justify-center gap-[5px] mt-[32px]">
              <p>ยังไม่มีบัญชี ?</p>
              <a href="./custsignup">
                <p className="font-bold text-[#FF8A00]">สร้างบัญชีใหม่</p>
              </a>
            </div>
          </div>
        </div>
